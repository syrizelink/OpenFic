        ...
        json={
            ...
            "theme_config": {
                "light": {
                    ...
                    "panel_background": "#fdf6e3",
                    "editor_background": "#fdf6e3",
                    "input_background": "#eee8d5",
                    "foreground": "#657b83",
                    "muted_foreground": "#839496",
                    "border": "#d6cdb0",
                    "border_subtle": "#eee8d5",
                    "hover_background": "#eee8d5",
                    "selection_background": "#b3d4cf",
                    "selection_foreground": "#073642",
                    "accent": "#268bd2",
                    "accent_foreground": "#fdf6e3",
                    "accent_hover": "#2aa198",
                    "link": "#2aa198",
                },
                "dark": {
                    ...
                    "hover_background": "#0b3b46",
                    "selection_background": "#0b4f5a",
