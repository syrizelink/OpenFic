...
export const PromptChainsTopBar = forwardRef<HTMLDivElement, PromptChainsTopBarProps>(
  function PromptChainsTopBar(
    {
      leadingSlot,
      entrySidebarTrigger,
      metadata,
    ...
    const agentOptions =
      selectedMode && selectedTask && metadata
        ? metadata.modes
            .find((m) => m.value === selectedMode)
